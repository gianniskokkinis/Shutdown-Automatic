...
def Shutdown30():
    ...
    window.grid()
    WarningText = Label(master=window, text="Your PC is going to shutdown after 30 minutes!",font=("Arial Black",18), bg="red")
    WarningText.grid()
    OKButton = Button(master=window, text="OK", font=("Arial Black",18), command=Exit)
    OKButton.grid()
...
def Shutdown1h():
    ...
    window.geometry("600x100")
    window.grid()
    WarningText = Label(master=window, text="Your PC is going to shutdown after 1 Hour!",font=("Arial Black",18), bg="red")
    WarningText.grid()
    OKButton = Button(master=window, text="OK", font=("Arial Black",18), command=Exit)
    OKButton.grid()
